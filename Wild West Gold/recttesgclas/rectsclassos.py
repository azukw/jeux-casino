...
number_font = pg.font.Font(None,40)
small_font = pg.font.Font(None,25)
big_font = pg.font.Font(None,35)
clock = pg.time.Clock()
bet_balance = 100.0
bet_pose = 0.0
bet_win = 0.0
...
class Button: 
    ...
    def check_click(self):
        ...
        if self.top_rect.collidepoint(mouse_pos):
            ...
            if pg.mouse.get_pressed()[0] and self.triggered==False:
                ...
                if self.pressed == True:
                    ...
                    if self.index == line:
                        ...
                        if self.index == -5 and commence == False and bet_pose>0.0:
                            ...
                            self.reset =True
                            self.aretirer=True
                            reponse = randint(1,2)  # Générer une nouvelle réponse ici
